...
cp -f ${XDG_DOWNLOAD_DIR}/R-Car_Gen3_Series_Evaluation_Software_Package_for_Linux-20180627.zip $PKGS_DIR
cp -f ${XDG_DOWNLOAD_DIR}/R-Car_Gen3_Series_Evaluation_Software_Package_of_Linux_Drivers-20180627.zip $PKGS_DIR
